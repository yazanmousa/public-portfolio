...
# urls
url = "https://olympicbaseballqualifier.wbsc.org/en/2019/e-2019-europe-africa-baseball-olympic-qualifier/stats/general/team/NED"
...
allTournamentStats['Year'] = '2019'
allTournamentStats['Tournament'] = 'A-Team-Europe-Africa'
...
# Overwrite csv file
allTournamentStats.to_csv("A-Team-Europe_Africa-2019.csv", index=False)
